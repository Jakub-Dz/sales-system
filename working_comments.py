...
class Basket:
    ...
    def add_item(self, item_name, quantity):
        ...
        self.items[item_name] = (new_quantity * stock.stock_dict[item_name]["price"],
                                 new_quantity)  # to musi byc robione przez transaction, bo basket teraz nie ma dostepu do stock
...
class Transaction:
    ...
    def __init__(self, user_name, user_wallet, stock_file):
        self.user = User(user_name, user_wallet)  # Hardcoded values as per project's specs
...
class SalesGUI:
    def __init__(self, master, transaction):
        ...
        # self.transaction.user.name -> "Basil Fawlty"
...
if __name__= "__main__":
    ...
    root = tk.Tk()
    gui = SalesGUI(root, transaction)  # przekazanie klasy do GUI
    root.mainloop()
